                ...
                <div class="row bg-light border-bottom border-end sticky-top" id="sticky-header-menu">
                    ...
                    <div class="d-flex flex-row align-items-center mb-3">
                        ...
                        <div class="input-group input-group-sm rounded" style="width: 250px;">
                            <button type="button"
                                class="btn btn-white bg-white border-end-0 border rounded-end rounded-pill px-3">
                                <em class="fas fa-search text-secondary"></em>
                            </button>
                        ...
                        <button type="button" class="btn btn-sm btn-primary ms-3 rounded-pill fw-bold">+ Kategori
                          </button>
                        <a href="#" data-bs-toggle="modal" data-bs-target="#modal-tambah-produk"><button
                                type="button" class="btn btn-sm btn-primary ms-3 rounded-pill fw-bold">+
                                Produk</button></a>
                    </div>
...
style="background-image: url('{{ asset('images') }}/{{ $product->foto1 }}'); background-size: cover;
background-position: center center;">
                        ...
                        <div class="col-2 py-3">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <a href="#" data-bs-toggle="modal"
                                            data-bs-target="#modal-edit-product-{{ $product->id }}"><em
                            ...
                            <div class="--sticky-table-item col d-flex flex-column justify-content-between">
                                <div class="row justify-content-between">
                                    <div class="col-auto">
                                        <a href="#" data-bs-toggle="modal"
                                            data-bs-target="#modal-hapus-product-{{ $product->id }}">
                    ...
                    <div class="col-2 py-3">
                        <div class="--sticky-table-item" style="z-index: 1;">
                            <div class="row">
                                <div class="col-auto">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-edit-product">
                                        <em class="fas fa-edit"></em>
                                    </a>
                                </div>
                                <div class="col-auto">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-hapus-product"><em
    ...
    <!-- modal: hapus product -->
    @foreach ($products as $product)
        <div class="modal fade" id="modal-hapus-product-{{ $product->id }}" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog modal-sm modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary btn-sm p-1 fw-bold w-100"
                            onclick="location.href='/delete-product/{{ $product->id }}'">Hapus</button>
    ...
    <!-- modal: tambah produk -->
    <div class="modal fade" id="modal-tambah-produk" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                ...
                                <div class="row mb-2">
                                    <div class="col">
                                        ...
                                        <input id="" type="text" name="name" class="form-control"
                                            required autocomplete="name" autofocus placeholder="Nama Produk">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col">
                                    ...
                                    <div class="col">
                                        ...
                                        <input id="" name="harga" type="number" class="form-control"
                                            required autocomplete="name" autofocus placeholder="Harga">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col">
                                        <p class="mb-0 fw-bold">Stok</p>
                                        <input id="" name="stok" type="number" class="form-control"
                                            required autocomplete="name" autofocus placeholder="Stok">
                                    </div>
                                    <div class="col">
                                        <p class="mb-0 fw-bold">Berat (gram)</p>
                                        <input id="" name="berat" type="number" class="form-control"
                                            required autocomplete="name" autofocus placeholder="Berat (gram)">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col">
                                        <p class="p-0 m-0 fw-bold text-break">Deskripsi</p>
                                        <textarea id="" name="deskripsi" type="text" class="form-control" name="name"
                                            rows="10" required autocomplete="name" autofocus placeholder="Deskripsi"
                                            style="overflow-y:scroll; max-height:100px;"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
    ...
    <!-- modal: edit produk -->
    @foreach ($products as $product)
        <div class="modal fade" id="modal-edit-product-{{ $product->id }}" data-bs-backdrop="static"
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col">
                                            <p class="p-0 m-0 fw-bold text-break">Deskripsi</p>
                                            <textarea id="" name="deskripsi" type="text" class="form-control"
                                                name="name" rows="10" required autocomplete="name" autofocus
                                                placeholder="Deskripsi" style="overflow-y:scroll; max-height:100px;">
                                                {{ $product->deskripsi }}
                                            </textarea>
                                        </div>
                                    </div>
    ...
    <div class="modal fade" id="modal-tambah-kategori" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <div class="modal-body">
                    <div class="row mb-2">
                        <div class="col">
                            ...
                            <input id="nama" type="text" class="form-control" required autocomplete="name"
    ...
    <!-- modal: hapus product -->
    <div class="modal fade" id="modal-hapus-product" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                            ...
                            <div class="row mb-2">
                                <div class="col">
                                    ...
                                    <input id="" type="text" class="form-control" required
                                        autocomplete="name" autofocus placeholder="Nama Produk">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col">
                                ...
                                <div class="col">
                                    <p class="mb-0 fw-bold">Harga</p>
                                    <input id="" type="number" class="form-control" required
                                        autocomplete="name" autofocus placeholder="Harga">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col">
                                    <p class="mb-0 fw-bold">Stok</p>
                                    <input id="" type="number" class="form-control" required
                                        autocomplete="name" autofocus placeholder="Stok">
                                </div>
                                <div class="col">
                                    <p class="mb-0 fw-bold">Berat (gram)</p>
                                    <input id="" type="number" class="form-control" required
                                        autocomplete="name" autofocus placeholder="Berat (gram)">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col">
                                    <p class="p-0 m-0 fw-bold text-break">Deskripsi</p>
                                    <textarea id="" type="text" class="form-control" name="name" rows="10" required
                                        autocomplete="name" autofocus placeholder="Deskripsi" style="overflow-y:scroll;
                        ...
                        <div class="col">
                            <div class="row mb-2">
                                <div class="col">
                                    ...
                                    <input id="" type="text" class="form-control" required
                                        autocomplete="name" autofocus placeholder="Nama Produk"
                                        value="VGA MSI GT1030 AERO ITX 2G OC | GT 1030 2GB1030 2GB">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col">
                                ...
                                <div class="col">
                                    <p class="mb-0 fw-bold">Harga</p>
                                    <input id="" type="number" class="form-control" required
                                        autocomplete="name" autofocus placeholder="Harga" value="1500000">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col">
                                    <p class="mb-0 fw-bold">Stok</p>
                                    <input id="" type="number" class="form-control" required
                                        autocomplete="name" autofocus placeholder="Stok" value="11">
                                </div>
                                <div class="col">
                                    <p class="mb-0 fw-bold">Berat (gram)</p>
                                    <input id="" type="number" class="form-control" required
                                        autocomplete="name" autofocus placeholder="Berat (gram)" value="800">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col">
                                    <p class="p-0 m-0 fw-bold text-break">Deskripsi</p>
                                    <textarea id="" type="text" class="form-control" name="name" rows="10" required
                                        autocomplete="name" autofocus placeholder="Deskripsi"
                                        style="overflow-y:scroll; max-height:100px;">
                                        Product Name : MSI GeForce GT 1030 2GB DDR4 - AERO ITX 2G OC
